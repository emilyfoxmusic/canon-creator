...
canon = [
  {pitch: :a4, length: 0.5}, {pitch: :g4, length: 0.5}, {pitch: :a4, length: 0.5},
  {pitch: :a4, length: 0.5}, {pitch: :g4, length: 0.5}, {pitch: :a4, length: 0.5},
  {pitch: :d5, length: 1}, {pitch: :c5, length: 0.5}, {pitch: :a4, length: 1},
  {pitch: :a4, length: 0.5}, {pitch: :g4, length: 0.5}, {pitch: :a4, length: 0.5},
  {pitch: :g4, length: 1}, {pitch: :f4, length: 1}, {pitch: :f4, length: 0.5},
  {pitch: :d4, length: 1}, {pitch: :c4, length: 0.5}, {pitch: :d4, length: 1}
