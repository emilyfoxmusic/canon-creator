...
sounds = [:prophet, :pretty_bell, :tb303]
...
canon = [
  {pitch: :c, length: 0.25}, {pitch: :e,  length: 0.25}, {pitch: :g, length: 0.5},
  {pitch: :f, length: 0.25}, {pitch: :a, length: 0.25}, {pitch: :c5, length: 0.5},
  {pitch: :d, length: 0.25}, {pitch: :f,  length: 0.25}, {pitch: :a, length: 0.5},
  {pitch: :c, length: 0.25}, {pitch: :e,  length: 0.25}, {pitch: :g, length: 0.5},
  {pitch: :e, length: 0.25}, {pitch: :g, length: 0.25}, {pitch: :b, length: 0.5},
  {pitch: :a, length: 0.25}, {pitch: :c5, length: 0.25}, {pitch: :e5, length: 0.5},
  {pitch: :f, length: 0.25}, {pitch: :a, length: 0.25}, {pitch: :c5, length: 0.5},
  {pitch: :e, length: 0.25}, {pitch: :g, length: 0.25}, {pitch: :b, length: 0.5},
  {pitch: :c, length: 0.25}, {pitch: :e,  length: 0.25}, {pitch: :g, length: 0.5},
  {pitch: :d, length: 0.25}, {pitch: :f,  length: 0.25}, {pitch: :a, length: 0.5},
  {pitch: :b, length: 0.25}, {pitch: :d5, length: 0.25}, {pitch: :f5, length: 0.5},
  {pitch: :c, length: 0.25}, {pitch: :e,  length: 0.25}, {pitch: :g, length: 0.5}
]
