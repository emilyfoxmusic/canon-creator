...
canon = [
  {pitch: :g, length: 1}, {pitch: :g,  length: 1}, {pitch: :e, length: 1},{pitch: :f, length: 0.5},{pitch: :g, length: 0.5},
  {pitch: :a, length: 1},
  {pitch: :c5, length: 0.5},{pitch: :a, length: 0.5},
  {pitch: :a, length: 0.5},{pitch: :c, length: 0.25},{pitch: :a, length: 0.25},
  {pitch: :b, length: 0.5}, {pitch: :c, length: 0.25},{pitch: :b, length: 0.25},
  {pitch: :c5, length: 0.5}, {pitch: :c, length: 0.5},
  {pitch: :c, length: 1}
